...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   forms.checkRadioButtonCorrespondingToCustomButton = function() {
    ...
    // 1.3. In this scenario, a yes/no question with radio buttons has another question, within the same <div class="field">, that is hidden.
    ...
    // 1.2. This function is for a container of form fields that are hidden until certain options are selected in other form controls above it. See the CSS file for example HTML.
    ...
    // 1.1.1. This is the main function for forms.consistentFormTableColumnWidths, invoked when the page loads and when the viewport resizes.
    ...
    // 1.1. This is a CSS-styling function involving selection too complex for a style sheet. It will make form tables within <form class="consistent-columns"> use the same widths for their two columns,
    ...
    // 1. Prepare JavaScript classes related to customizing the layout. This includes widgets, such as nested forms, and page load effects which CSS can't handle.
    forms.prepareLayoutScripting = function() {
        forms.consistentFormTableColumnWidths();
        forms.nestedForms();
        forms.prepareYesNoFollowUps();
    };
