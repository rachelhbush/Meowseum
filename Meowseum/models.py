...
class Shelter(models.Model):
    ...
    profile_address = models.OneToOneField(Address, related_name="shelter_profile", null=True)
...
or a nonprofit with charitable status granted by the Canada Customs and Revenue Agency?",
    ...
    mailing_address = models.OneToOneField(Address, related_name="shelter", null=True)
