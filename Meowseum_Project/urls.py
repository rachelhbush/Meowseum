...
urlpatterns = [
    ...
    url(r'^slide/(?P<relative_url>.+)/edit_upload$', 'Meowseum.views.edit_upload.page', name="edit_upload"),
    ...
    url(r'^slide/(?P<relative_url>.+)/add_comment$', 'Meowseum.views.add_comment.page', name="add_comment"),
